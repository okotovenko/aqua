(() => {
            ...
            if (bodyLockStatus) {
                ...
                if (this.targetOpen.element) {
                    if (this.youTubeCode) {
                        ...
                        const urlVideo = `https://player.vimeo.com/video/${codeVideo}`;
    ...
    function initSliders() {
        if (document.querySelector(".masks__slider")) new swiper_core_Swiper(".masks__slider", {
            ...
            navigation: {
                prevEl: ".masks-button-prev",
                nextEl: ".masks-button-next"
            },
            on: {}
        });
    ...
    function deleteTextSpanVideo() {
        ...
        const spanVideoPlay = document.querySelectorAll(".btn");
        if (windowInnerWidth < 768) spanVideoPlay.forEach((element => {
            if (element.innerText.includes("It")) element.innerText = element.innerText.replace(/\bIt\b/g, "").trim();
        }));
    }
    function preloader() {
        window.addEventListener("load", (function() {
